...
class JackBeginScheming extends Scene {
  ...
  bool canRepeat = false;
	...
	dynamic grimChat1(div, player1, player2){
		...
		}else if(player2.aspect == Aspects.DOOM || player2.aspect == Aspects.MIND){
	...
	void renderContent(Element div){
		...
		this.session.available_scenes.insert(0, new ConfrontJack(session));//make it top priority, so unshift, don't push
